	    ...
	    while (isRunning) {
            ...
            switch (option) {
                case 1:
                    ...
                    System.out.println(ShapeCollection.shapes);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    perimeterMax.add(listShapes.getLargestPerimeter());
                ...
                case 4:
                    ...
                    areaMax.add(Collections.singletonList(listShapes.getLargestArea()));
